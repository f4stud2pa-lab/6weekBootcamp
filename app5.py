...
Original file is located at
    https://colab.research.google.com/drive/1sAcCn7t6N54qIjaAUJZdwWnhbPwZxq1u
"""
...
df = pd.read_csv('/content/sunspots_for_prophet.csv')
...
model.add_seasonality(name='11_year_cycle', period=365.25 * 11, fourier_order=5)
model.fit(df)
...
# 실제 데이터
ax.plot(df["ds"], df["y"], label='Actual', color='black', alpha=0.6)
# 예측 데이터
